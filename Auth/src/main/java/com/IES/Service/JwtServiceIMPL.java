...
//import com.IES.Security.CustomeUserDetails;
...
public class JwtServiceIMPL implements  JwtService {
	...
	@Override
	public String generateToken(CustomerUserService userDetails) {
		log.debug("generateToken({})", userDetails.getEmail());
		return generateToken(new HashMap<>(), userDetails);
	}

	@Override
	public String generateToken(Map<String, Object> extraClaims, CustomerUserService userDetails) {
	...
	private String buildToken(Map<String, Object> extraClaims, CustomerUserService userDetails, long expiration) {
	...
	@Override
	public boolean isTokenValid(String token, CustomerUserService userDetails) {
